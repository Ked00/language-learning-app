export const questionList = {
  English: [
    ...
    {question: "how long have you been working here", correct: false, topic: "humans"},
  ...
  spanish: [
    ...
    {question: "Los niños y niñas están corriendo", correct: false, topic: "humans"},
    {question: "Los hombres y las mujeres están bebiendo café", correct: false, topic: "humans"},
    {question: "Ya casi es hora de empezar a cocinar", correct: false, topic: "humans"},
    {question: "Nosotros fuimos a andar en el carro azul ayer", correct: false, topic: "humans"},
    {question: "Mi nombre es Mike", correct: false, topic: "humans"},
  ],
};